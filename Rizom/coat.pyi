...
class cStr:
	...
	def __init__(self): ...
	def Copy (self, _0: str) : 
		'''
		-------------------------------------------------------------------------
		'''

	def Copy (self, _0: str, StartIndex: any, Count: any) : ...
	def Copy (self, _0: any) : ...
	def __assign__ (self, _0: str) : ...
	def __assign__ (self) : ...
	...
	Empty: cStr
	@staticmethod
	def Equals (_0: str, _1: str) -> bool : 
		'''
		-------------------------------------------------------------------------
		'''

	@staticmethod
	def EqualsNoCase (_0: str, _1: str) -> bool : ...
	@staticmethod
	def EqualsNoCase (_0: str, _1: str, MaxLength: any) -> bool : ...
	@staticmethod
	def Compare (_0: str, _1: str) -> int : 
		'''
		-------------------------------------------------------------------------
		'''

	@staticmethod
	def Compare (_0: str, _1: str, MaxLength: any) -> int : ...
	@staticmethod
	def CompareNoCase (_0: str, _1: str) -> int : ...
	@staticmethod
	def CompareNoCase (_0: str, _1: str, MaxLength: any) -> int : ...
	@staticmethod
	def EqualsPath (_0: str, _1: str) -> bool : 
		'''
		-------------------------------------------------------------------------
		'''

	@staticmethod
	def EqualsPath (_0: str, _1: str, MaxLength: any) -> bool : ...
	@staticmethod
	def ComparePath (_0: str, _1: str) -> int : 
		'''
		-------------------------------------------------------------------------
		'''

	@staticmethod
	def ComparePath (_0: str, _1: str, MaxLength: any) -> int : ...
	...
	def Append (self, _0: str, StartIndex: any, Count: any) : ...
	def Append (self, _0: any) : ...
	def Append (self, _0: any, Count: any) : ...
	def Append (self, _0: bool) : ...
	def Append (self, _0: int) : ...
	def Append (self, _0: float, Prec: int = 2) : ...
	def Append (self, _0: float, Prec: int = 6) : ...
	EndLn: cStr
	...
	def Insert (self, Index: int, _1: str) : 
		'''
		-------------------------------------------------------------------------
		'''

	def Insert (self, Index: int, _1: str, StartIndex: any, Count: any) : ...
	def Insert (self, Index: int, _1: any) : ...
	def Insert (self, Index: int, _1: any, Count: any) : ...
	def Insert (self, Index: int, _1: bool) : ...
	def Insert (self, Index: int, _1: int) : ...
	def Insert (self, Index: int, _1: float, Prec: int = 2) : ...
	def Insert (self, Index: int, _1: float, Prec: int = 6) : ...
