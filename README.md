...
In the folder /Addons/Rizom/Rizom/ there is 2 files: RizomSendRM.py and RizomSendUV.py. You must comment out the unfold3D.exe version and enable the rizomuv.exe version.
